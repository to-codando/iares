...
`);return`@media ${c.trim()} {
${g}
}`})},"wrapLooseRulesInsideMediaQuery"),A=n(({style:s,selector:r})=>{let e=/\.(\w+)/g;return s.replace(e,`.${r}_$1`)},"applyClassNameScope"),h=n((s,r)=>{let e=s,l=`.${r}`;return e=A({style:e,selector:r}),e=P({style:e,selector:l}),e=w({style:e,selector:l}),e},"transformStyle");var b=new Map,f=n(s=>{let r=b.get(s);if(r!==void 0)return r;let e=document.createElement("style");return e.setAttribute("data-component",s),document.head.appendChild(e),b.set(s,e),e},"createStyleElement");var L=new Map,v=n((s,r=()=>{})=>(e,...l)=>{let u=e.reduce((i,y,p)=>`${i}${y}${l[p]!==void 0?l[p]:""}`,""),c=L.get(u);if(c!==void 0)return c;let a=S(u,s),m=h(u,`${a}`),g=f(`${a}`);return r({hashId:a,scopedStyle:m,styleElement:g}),g.innerHTML.includes(m)||(g.innerHTML+=m),L.set(u,a),a},"css");export{v as css};
